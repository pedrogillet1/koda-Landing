// Visual audit of integrations.html across 8 breakpoints in PT and EN.
...
const BASE = 'http://localhost:8080/integrations.html';
const OUT = '/Users/alvarocamasmie/Downloads/koda-Landing/qa-screenshots/integrations-redesign';
