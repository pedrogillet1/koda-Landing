// Visual audit of security-overview.html across 8 breakpoints in PT and EN.
...
const BASE = 'http://localhost:8080/security-overview.html';
const OUT = '/Users/alvarocamasmie/Downloads/koda-Landing/qa-screenshots/security-overview-redesign';
